...
export class AuthorController {
    ...
    createRouter() {
        ...
        authorRouter.put('/update/:id', this.middleware.verify, this.authorMiddleware.author, (req, res) => {
            this.authorService.updateAuthor(+req.params.id, req.body, res);
        })
        authorRouter.delete('/delete/:id', this.middleware.verify, this.authorMiddleware.author, (req, res) => {
            this.authorService.deleteAuthor(+req.params.id, res);
        })
        authorRouter.get('/:id', this.middleware.verify, this.authorMiddleware.author, (req, res) => {
            this.authorService.findOneAuthor(+req.params.id, res);
        })
        authorRouter.get('/', this.middleware.verify, this.authorMiddleware.author, (req, res) => {
